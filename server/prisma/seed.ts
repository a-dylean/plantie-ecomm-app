  ...
  async function main() {
    const monstera = await prisma.product.upsert({
        ...
        create: {
            name: 'Monstera',
            price: 15,
            description: "Meet Monstera, the fierce but fabulous foliage that's sure to turn heads. This funky friend is equal parts playful and stylish, with oversized leaves that add a pop of personality to any room. Just don't be surprised if you find yourself giving it a little wink and a nod every time you walk by.",
